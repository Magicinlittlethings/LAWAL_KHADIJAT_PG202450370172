...
CSC 825 project demonstrating the four pillars of Object Oriented Programming.
To view the source code, navigate to the src folder and then the FuelStationDemo.java file.
To get more explanation on what the code dose, navigate to the projectexplanation.md file
